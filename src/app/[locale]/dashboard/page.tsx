...
type DashboardRequest = {
  ...
  procurements: Array<{
    ...
    offers: Array<{ id: string; workerId: string; totalAgorot: number; createdAt: Date; updatedAt: Date; scopeInclusions: string; assumptions: string | null; proposedDate: Date | null; duration: string | null; validUntil: Date; state: string; worker: { user: { name: string } }; messages: Array<{ id: string; message: string; author: { name: string } }> }>;
  }>;
};
