  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f6f8f7] px-6 py-12">
      <div className="w-full max-w-md rounded-3xl border border-[#e0e9e4] bg-white p-8 shadow-xl shadow-[#176b4d]/5">
        ...
        <h1 className="mt-10 text-3xl font-bold tracking-tight text-[#10251b]">{mode === "login" ? (isArabic ? "مرحبًا بعودتك" : "Welcome back") : (isArabic ? "أنشئ حسابك" : "Create your account")}</h1>
        <p className="mt-2 text-base text-[#3f5148]">{isArabic ? "أدر طلبات الصيانة بثقة وسهولة." : "Manage maintenance requests with confidence."}</p>
